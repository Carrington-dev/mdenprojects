    ...
    <div class="container">
      ...
      <div class="row skills-content">
        ...
        <div class="col-lg-6" data-aos="fade-up">
          ...
          <div class="progress">
            <span class="skill">Project development and Management <i class="val">100%</i></span>
          ...
          <div class="progress">
            <span class="skill">Troubleshooting <i class="val">100%</i></span>
            <div class="progress-bar-wrap">
              <div class="progress-bar" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
          </div>
          ...
          <div class="progress">
            <span class="skill">Blueprint Reading <i class="val">100%</i></span>
            <div class="progress-bar-wrap">
              <div class="progress-bar" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
          </div>
          <div class="progress">
            <span class="skill">Installation <i class="val">89%</i></span>
            <div class="progress-bar-wrap">
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="progress">
            <span class="skill">Electrical Services <i class="val">92%</i></span>
            <div class="progress-bar-wrap">
          ...
          <div class="progress">
            <span class="skill">Certificate of compliance <i class="val">91%</i></span>
            <div class="progress-bar-wrap">
